...
const ekainosFont = localFont({ src: '../../public/fonts/ekainos.ttf' });
  ...
  return (
    <header className="sticky top-0 z-50 bg-paper/95 backdrop-blur-sm border-b border-rule px-4 md:px-8 py-3 flex items-center justify-between shadow-[0_1px_0_var(--rule)]">
      <div className="flex items-center gap-8">
        <Link href="/" className={`text-3xl text-blue-600 tracking-tight flex items-center gap-2 relative ${ekainosFont.className}`}>
          september
