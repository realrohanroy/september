export default function RefundPage() {
  return (
    <>
      <h1 className="text-3xl font-heading font-bold text-ink mb-6">Refund Policy</h1>
      <p className="text-ink/70 mb-4">Last updated: 24 September 2026</p>
      
      <h2 className="text-xl font-heading font-bold text-ink mt-8 mb-4">1. General Policy</h2>
      ...
      <h2 className="text-xl font-heading font-bold text-ink mt-8 mb-4">2. Erroneous Transactions</h2>
      <p className="text-ink/80 leading-relaxed mb-6">
