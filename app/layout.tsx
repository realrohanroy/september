  ...
  return (
    <html lang="en">
      ...
      >
        <header className="sticky top-0 z-10 bg-paper/95 backdrop-blur-sm border-b border-rule px-4 md:px-8 py-3 flex items-center justify-between shadow-[0_1px_0_var(--rule)]">
          <div className="flex items-center gap-4 md:gap-8">
            <div className="flex items-center">
              <BackButton />
              <Link href="/" className="text-2xl font-heading font-extrabold text-sindoor tracking-tight flex items-center gap-2">
                september
          ...
          <div className="flex items-center gap-4">
            <Link href="/give" className="bg-sindoor text-paper rounded-none] px-5 py-2 text-sm font-bold transition-transform active:scale-[0.98] hover:opacity-90 hidden md:block">
              Give ₹51
            </Link>
        ...
        {/* Universal Footer */}
        <footer className="bg-card border-t border-rule mt-24">
