    ...
    <main className="flex flex-col w-full min-h-screen bg-gray-50 font-sans">
      ...
      <div className="w-full max-w-[800px] mx-auto px-4 py-12 md:py-20 flex-1 flex flex-col">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 md:p-12">
          <h1 className="text-3xl md:text-4xl font-heading font-bold text-gray-900 mb-6">Contact Us</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h3 className="font-heading font-bold text-gray-900 mb-2">Email Support</h3>
              <p className="text-gray-700 mb-1">hello@september.org</p>
              <p className="text-sm text-gray-500">We typically reply within 24 hours.</p>
            </div>
            
            <div>
              <h3 className="font-heading font-bold text-gray-900 mb-2">Registered Address</h3>
